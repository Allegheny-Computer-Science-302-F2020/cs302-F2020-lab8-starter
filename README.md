...
* [Laboratory Assignment Tasks](#laboratory-assignment-tasks)
  + [Using JavaScript to Dynamically Generate HTML Content](#using-javascript-to-dynamically-generate-html-content)
...
- To download graphics files from an external GitHub repository
- To add graphics files to a project's GitHub repository
...
`Allegheny-Computer-Science-302-Fall-2020/computer-science-302-fall-2020-lab-8-gkapfham`.
...
```
git clone git@github.com:Allegheny-Computer-Science-302-F2020/computer-science-302-fall-2020-lab-8-gkapfham.git
```
...
### Using JavaScript to Dynamically Generate HTML Content
...
As you start editing the provided source code, please review the content that is
on pages 383 and 384 of the textbook. Then, you should study the `TODO` markers
...
provided by the GitHub repository mentioned in the `country.js` file. Specially,
you will need to go to the GitHub repository
[country-flags](https://github.com/hjnilsson/country-flags) and download
appropriately sizes images, in either SVG or PNG format, and save them in the
`src/www/img` directory. You should also make sure that you use the `git add`
and `git commit` commands to place these images inside of your GitHub
repository.

Next, you will research and include the full details about five additional
countries that are not mentioned in the textbook. This means that your web site
will ultimately contain content like that on page 383 for a total of ten
countries. It is important to note that the textbook's label written as
"**iso**" stands for the ISO-3166 country code that was assigned to each country
by the International Standards Organization. You can use this two-letter code to
find the required flag image for each country.

In summary, you must modify the provided HTML so that it links to the
...
country boxes as they are given on page 383. Again, make sure that you correctly
reference the CSS file from HTML source code. As in previous assignments, please
study the provided source code and review the course slides if you have
questions about the steps for completing this assignment.
...
you should verify the correctness of all its components (e.g., your web site
should feature appropriately styled details about ten countries in total,
including the flag, ISO-3166 country code, current capital, and an estimate of
...
- The file bs.png exists in the src/www/img/flags directory
- The file ca.png exists in the src/www/img/flags directory
- The file country.js exists in the src/www/js directory
- The file de.png exists in the src/www/img/flags directory
- The file es.png exists in the src/www/img/flags directory
- The file gb.png exists in the src/www/img/flags directory
...
- The index.html in src/www/ has at least 1 of the `country.js` fragment
...
- The index.html in src/www/ has at least 1 of the `<title>Flags of the World</title>` fragment
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 25/25 (100%) of checks for cs302-F2020-lab8! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-302-F2020/cs302-F2020-lab8-starter.git
```
